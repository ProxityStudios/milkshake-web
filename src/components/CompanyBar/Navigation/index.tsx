...
const CompanyBarNavigationComponent: CompanyBarNavigationComponentProps = (props) => {
     return (
          <HStack justifyContent="flex-end" spacing="5" {...props}>
               <Link letterSpacing="wide" href={Constants.Company.BaseURI} isExternal>Home <ExternalLinkIcon /></Link>
               <Link letterSpacing="wide" href={Constants.Company.BaseURI + "/products"} isExternal>Products <ExternalLinkIcon /></Link>
               <Link letterSpacing="wide" href={Constants.Company.BaseURI + "/terms-of-service"} isExternal>Terms <ExternalLinkIcon /></Link>
          </HStack>
     );
};
